...
attack_order = random_order(1239)

attack_times = range(1241)
attack_times = attack_times[1:]
computer_network_resilience = compute_resilience(computer_network_graph, attack_order)
ER_graph_resilience = compute_resilience(ER_graph, attack_order)
UPA_graph_resilience = compute_resilience(UPA_graph, attack_order)
...
plt.title('Three undirected graphs resilience for random attack order')
