...
plt.figure()
plt.plot(size_UPA, fto_time, '-b', label = 'fast_targeted_order')
plt.plot(size_UPA, to_time, '-g', label = 'targeted_order')
plt.legend(loc = 'upper right')
plt.title('Computation time of fast & normal targeted order algorithm(Desktop Python)')
